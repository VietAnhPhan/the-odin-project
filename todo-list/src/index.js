...
const projects =
    [
        ...
        new Project('Self Improvement', [{ title: 'IELTS test', description: 'get up early', dueDate: '03-22-2026', priority: true, project: 'project 2', completed: false },
